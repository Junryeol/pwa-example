...
class githubBackAPI {
  ...
  auth(user_name, headers) {
    this.user_name = user_name;
    this.headers = headers;
    this.private_repos_url = `${this.github_api_base_url}/repos/${this.user_name}/${this.private_repos_name}`;
    this.repos_url = `${this.github_api_base_url}/user/repos`;
    this.file_system_url = `${this.github_api_base_url}/repos/${this.user_name}/${this.private_repos_name}/contents/${this.file_system_path}`;
    this.blobs_url = `${this.github_api_base_url}/repos/${this.user_name}/${this.private_repos_name}/git/blobs`;

    console.log("auth", this.user_name, this.headers);

    fetch(this.private_repos_url, {
      method: "get",
      headers: this.headers
    }).then(data => {
  ...
  update() {
    return fetch(this.file_system_url, {
      method: "get",
      headers: this.headers
    }).then(data => {
      data.json().then(json => {
